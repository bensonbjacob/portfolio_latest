...
export default function RootLayout({
  ...
  return (
    <html lang='en' className='!scroll-smooth'>
      <body
        className={`${inter.className} bg-gray-50 dark:bg-gradient-to-r from-mountain-meadow-800 to-mountain-meadow-900  text-gray-950 dark:text-gray-50 relative pt-28 sm:pt-36`}
      >
