...
export default function Project({
  ...
  return (
    <motion.div
      ...
      <article className="bg-gray-100 hover:bg-gray-200 transition max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[24rem] sm:group-even:pl-8 dark:bg-transparent dark:border-2 dark:border-[rgb(71,87,105)]">
